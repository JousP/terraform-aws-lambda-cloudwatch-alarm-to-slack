...
output "role_assume_role_policy" {
  ...
  value       = "${module.basic_usage.role_assume_role_policy}"
}
...
output "role_force_detach_policies" {
  ...
  value       = "${module.basic_usage.role_force_detach_policies}"
}
...
output "role_max_session_duration" {
  ...
  value       = "${module.basic_usage.role_max_session_duration}"
}
...
output "role_path" {
  ...
  value       = "${module.basic_usage.role_path}"
}
...
output "function_qualifier" {
  ...
  value       = "${module.basic_usage.function_qualifier}"
}
